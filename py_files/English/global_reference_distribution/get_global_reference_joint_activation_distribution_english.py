...
# Configuration
INPUT_DATA_PATH = "home_directorycsln/data/input/target_context_pairs/pwi_target_distractor_english.csv"
OUTPUT_PATH = "home_directorycsln/data/output/pwi_target_distractor_english_reference_joint_activation_distribution.npy"
...
def load_dm_matrices(dm_dir):
    ...
    for k in tqdm(range(1, 6), desc="Loading DM matrices", unit="matrix"):
        filepath = Path(dm_dir) / f"english_fasttext_dm_power_k{k}.npy"
