...
#SBATCH --output=home_directorycsln/data/logs/get_global_reference_distribution-%j.out
#SBATCH --error=home_directorycsln/data/logs/get_global_reference_distribution-%j.err
...
# 3. Run the builder
# ------------------------------------------------------------------
python home_directorycsln/py_files/get_global_reference_joint_activation_distribution.py \
  --embeddings      "$EMB" \
  --max-words       "$MAX_WORDS" \
